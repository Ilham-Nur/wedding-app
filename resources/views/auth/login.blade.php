          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center fs-30 fw-bold text-uppercase mb-4">ARCDEV WEDDING</p>
                ...
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" placeholder="Masukan Alamat Email" class="form-control" name="email" id="email"
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Belum Memiliki Akun Harap Menghubungi Admin</p>
