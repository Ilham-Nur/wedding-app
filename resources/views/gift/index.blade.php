            ...
            <form id="editGiftForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_no_rekening" name="no_rekening" required>
                    </div>
                    <div class="mb-3">
...
$(function() {
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        $.get('/gift/' + id + '/edit', function(res) {
            ...
            $('#edit_pernikahan_id').val(res.pernikahan_id || pernikahanId); // pastikan terisi
